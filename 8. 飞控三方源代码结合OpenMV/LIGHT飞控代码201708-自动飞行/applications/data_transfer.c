...
extern float move_front,move_back,turn_right,turn_left;//运动指令
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		LIGHT_DT_Send_Senser(mpu6050.Acc.x,mpu6050.Acc.y,0,
												(s16)move_front,(s16)turn_left,(s16)start_flag,
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid5 = 0;
		LIGHT_DT_Send_PID(5,0,0,0,0,0,0,0,0,0);
	}
	else if(f.send_pid6)
	{
		f.send_pid6 = 0;
