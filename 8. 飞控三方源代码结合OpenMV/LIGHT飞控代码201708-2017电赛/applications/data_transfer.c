...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		LIGHT_DT_Send_Status(PixFlow_Roll,PixFlow_Pitch,Yaw,(0.1f *baro_fusion.fusion_displacement.out),0,fly_ready);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		 f.send_senser = 0;// 
		 LIGHT_DT_Send_Senser((int16_t)my_data[4],(int16_t)my_data[5],(int16_t)turn_flag,
												(int16_t)X_Offset, (int16_t)Y_Offset,(int16_t)exp_speed_x,
