...
void h_pid_init()
{
	...
	h_acc_arg.ki = 0.07f *pid_setup.groups.hc_sp.kp;				//»ı·ÖÏµÊı
  ...
  //¶¨¸ßËÙ¶È»·
	h_speed_arg.kp = 5.0f *pid_setup.groups.hc_sp.kp;				//±ÈÀıÏµÊı
	...
	//¶¨¸ß¸ß¶È»·
	h_height_arg.kp = 1.0f *pid_setup.groups.hc_height.kp;				//±ÈÀıÏµÊı
	h_height_arg.ki = 0.0f *pid_setup.groups.hc_height.ki;				//»ı·ÖÏµÊı
	h_height_arg.kd = 0.02f *pid_setup.groups.hc_height.kd;				//Î¢·ÖÏµÊı
	h_height_arg.k_pre_d=0.01f;
	h_height_arg.inc_hz =20;
	h_height_arg.k_inc_d_norm = 0.5f;
	h_height_arg.k_ff = 0;	
	//¹âÁ÷ËÙ¶È»·PID¿ØÖÆ
  x_speed_arg.kp = 5.0f *pid_setup.groups.hc_sp.kp;				//±ÈÀıÏµÊı
  ...
  y_speed_arg.kp = 5.0f *pid_setup.groups.hc_sp.kp;				//±ÈÀıÏµÊı
  ...
  //¹âÁ÷Î»ÖÃ»·PID¿ØÖÆ
	y_offset_arg.kp = 1.0f *pid_setup.groups.hc_height.kp;				//±ÈÀıÏµÊı
	y_offset_arg.ki = 0.0f *pid_setup.groups.hc_height.ki;				//»ı·ÖÏµÊı
	y_offset_arg.kd = 0.02f *pid_setup.groups.hc_height.kd;				//Î¢·ÖÏµÊı
	...
	//¹âÁ÷Î»ÖÃ»·PID¿ØÖÆ
	x_offset_arg.kp = 1.0f*pid_setup.groups.hc_height.kp;				//±ÈÀıÏµÊı
	x_offset_arg.ki = 0.0f*pid_setup.groups.hc_height.ki;				//»ı·ÖÏµÊı
	x_offset_arg.kd = 0.02f*pid_setup.groups.hc_height.kd;				//Î¢·ÖÏµÊı
