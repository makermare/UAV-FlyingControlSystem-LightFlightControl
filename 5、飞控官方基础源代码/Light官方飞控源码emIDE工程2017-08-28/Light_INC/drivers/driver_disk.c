...
/*-----------------------------------------------------------------------*/
#include "stm32f4xx.h"
#include "driver_disk.h"		/* FatFs lower layer API */
#include "device_fatfs_conf.h"

/* Definitions of physical drive number for each drive */
#define SPI_FLASH		0	/*  Map spi nor flash to physical drive 0 */

extern flash_info_t *Flash_GetInfo(void);
extern void Flash_Init(void);
extern void Flash_SectorsRead(uint32_t address,uint8_t *buffer,uint16_t count);
extern void Flash_SectorsWrite(uint32_t address,uint8_t *buffer,uint16_t count);
